...
def update_head_direction(direction):
    with open("head_direction.txt", "w") as file:
...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
            ...
            # Write head direction and angles to the file
            with open("head_direction.txt", "w") as file:
                file.write(f"{text}, x: {x:.2f}, y: {y:.2f}, z: {z:.2f}")
